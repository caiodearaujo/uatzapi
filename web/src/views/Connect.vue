          ...
          <v-col cols="12" md="6">
            <v-list lines="one">
              <v-list-item>
                <v-list-item-content>
                  <v-list-item-title
                    >1. Abra o WhatsApp no seu celular</v-list-item-title
                  >
                </v-list-item-content>
              </v-list-item>
              <v-list-item>
              ...
              <v-list-item>
                <v-list-item-content>
                  <v-list-item-title
                    >3. Toque em <b>Dispositivos conectados</b> e, em seguida,
                    em <b>Conectar dispositivo.</b></v-list-item-title
                  >
                </v-list-item-content>
              </v-list-item>
              <v-list-item>
